...
VoTT_Folder = os.path.join(r"C:\Users\Ashis\Downloads\Compressed\Train your YOLO\TrainYourOwnYOLO-master\Data\Source_Images\Training_Images")
VoTT_csv = os.path.join(VoTT_Folder, "vott-csv-export", "Annotations-export.csv")
YOLO_filename = os.path.join(VoTT_Folder, "data_train.txt")

model_folder = os.path.join(Data_Folder, "Model_Weights")
classes_filename = os.path.join(r"C:\Users\Ashis\Downloads\Compressed\Train your YOLO\TrainYourOwnYOLO-master\Data\Model_Weights", "data_classes.txt")
